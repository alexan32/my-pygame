...
class imageObject(gameObject):
    ...
    def __init__(self, pos, path, screen, material=None, flag=None, id=None):
        gameObject.__init__(self, pos, material=material, flag=flag, id=id)
        self.image = image(pos, path, screen)
...
class spriteObject(gameObject):
    ...
    def __init__(self, pos, frames, screen, material=None, flag=None, id=None, frame_rate=7):
        gameObject.__init__(self, pos, material=material, flag=flag, id=id)
        self.sprite = spriteAnimation(frames, screen, pos, frame_rate)
